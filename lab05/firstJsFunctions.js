...
function testAll(){
    ...
    ans = this.myFunctionTest("nur", reverse("run"));
    console.log("Expected output of reverse(\"run\") is nur " + ans);

    ans = this.myFunctionTest("congrats", findLongestWord(["congrats", "run", "fire"]));
    console.log("Expected output of findLongestWord(\"congratss\", \"run\", \"fire\"]) is congrats " + ans);

    ans = this.myFunctionTest(["congrats", "fire"], filterLongWords(["congrats", "run", "fire"], 3));
    console.log("Expected output of findLongestWord(\"congratss\", \"run\", \"fire\"], 3) is [\"congrats\", \"fire\"], " + ans);
}
